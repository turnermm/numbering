<?php
$lang['nstart'] = 'The number at whch you want to start your count';
...
$lang['format'] = 'This is a string which is used to format the returned value, where %d represents the date and %n the number and %i&lt;n&gt; image number n. '
    . '  Like the date style this can also take format specifiers. For instance: <b>** Date: %d Number: %n **</b>';
$lang['imgs'] = 'Comma separated list of images located in data/media, e.g <b>:image.png,:wiki:other_image.png, . . .</b>'
