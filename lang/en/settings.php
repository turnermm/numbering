...
$lang['format']                = 'This is a string which is used to format the returned value, where %d represents the date , %n the number, %i&lt;n&gt; image number n, and %R a text selection from the editor.   Like the date style this can also take format specifiers. For instance: <b>** Date: %d Number: %n **</b>';
